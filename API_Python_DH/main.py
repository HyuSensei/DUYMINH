...
from routes.admin import auth as authAdmin, product as productAdmin, user, category as categoryAdmin, roles, order as orderAdmin,brand as brandAdmin
app = FastAPI()
...
app.include_router(brandAdmin.router)